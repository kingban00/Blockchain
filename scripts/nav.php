<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="tables_dynamic.php" class="site_title"><i class="fa fa-paw"></i> <span>Clinikus</span></a>
					</div>
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-edit"></i> Clientes <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										...
										<li><a href="tables_dynamic.php">Lista de clientes</a></li>
									</ul>
								</li>
						...
						<ul class=" navbar-right">
							<li class="nav-item dropdown open" style="padding-left: 15px;">
								<a href="javascript:;" class="user-profile dropdown-toggle" aria-expanded="false">
									<img src="images/img.jpg" alt="">Yann Gabriel
								</a>
